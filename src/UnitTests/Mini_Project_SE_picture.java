...
//
//		//scene.geometries.add(new Plane(new Point3D(550, 150, 360), new Vector(0, 0, -1)).setEmission(Color.BLUE)
//		//		.setMaterial(new Material().setKd(0.4).setKs(0.3).setnShininess(100).setKT(0.3))
//		// new Plane(new Point3D(0,150,0),new
//		// Vector(0,-1,0)).setEmission(Color.CYAN).setMaterial(new
